...
import messages from "../../Commands/spaceCommands/spaceTwo.js";
import Logger from "../../Logger/Logger.js";
import methods from "../../Commands/spaceCommands/methodIds.js";
import { CL_dependeciesLoaded, CL_login, CL_loginByHash, CL_loginFollowUp, CL_registerUid } from "../../Commands/spaceCommands/commands.js";
import { HttpsProxyAgent } from "https-proxy-agent";

const spaceIdString = "100045260"; // Used for logs
const spaceIdInString = "0000000005f691cc";
const space = "Two";

class SpaceTwo extends Space {
  ...
  connectToServer() {
    return new Promise((resolve, reject) => {
      ...
      this.socket.onopen = (e) => {
        this.logger.info("[SpaceConnectionOpened] - 100045260");
        this.socket.send(new DataView(hstab(`002a0003${this.normalHash}0000000005f691cc`), 0, 44));
  ...
  outgoingPacketHandler(packetName, payload) {
    switch (packetName) {
      case "CL_dependeciesLoaded":
        return new CL_dependeciesLoaded(100045260, 1816792453857564692n).serialize();
      case "CL_loginByHash":
        return new CL_loginByHash(this.Password, 100045260, 7981625407112679465n).serialize();
      case "LoginByHashModelServer_loginBySingleUseHash":
        return new CL_loginByHash(this.Password, 100045260, 8443757983603200274n, true).serialize();
      case "CL_Collection_Messages":
        return Object.values(messages);
      case "CL_loginFollowUp":
        return new CL_loginFollowUp().serialize();
      case "CL_registerUid":
        return new CL_registerUid(payload.Nickname, payload.Password).serialize();
      case "CL_loginByPassword":
        return new CL_login(payload).serialize();
      default:
